#!/bin/bash
# Script to generate algorithm problem descriptions using FIM (Fill-in-Middle) mode
...
echo "🚀 Starting FIM problem generation in background..."

nohup python scripts/datagen/generate_problems.py --mode fim "$@" > /dev/null 2>&1 &
